  ...
  return (
    <div>
      ...
      <div className='flex flex-col  sm:flex-row items-start gap-5 mt-5'>
        <button className={`py-1 px-3 border rounded text-sm transition-all sm:hidden ${showFilter ? 'bg-[#0A6C74] text-white':''}`} onClick={()=>setShowFilter(prev =>!prev)}>Filters</button>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 pt-2 px-3
      sm:px-1 mt-0'>  
        {
